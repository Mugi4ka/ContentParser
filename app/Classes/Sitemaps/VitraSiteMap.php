...
class VitraSiteMap implements \App\Interfaces\SiteMapInterface
{

    public function createSiteMap($siteLink)
    {
        $path = storage_path('app/santechsystemy.xml');
    ...
    {
        $itemLinks = [];
        $xml = XmlParser::load(storage_path('app/santechsystemy.xml'));
